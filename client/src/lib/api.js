...
export const api = {
  ...
  generateWeekDetail: (planId, weekId, body = {}) => request(`/api/plans/${planId}/weeks/${weekId}/generate`, { method: 'POST', timeout: 120000, body: JSON.stringify(body) }),
  getWeekGenerationContext: (planId, weekId) => request(`/api/plans/${planId}/weeks/${weekId}/generation-context`),
